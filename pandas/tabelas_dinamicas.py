...
PERC_COMISSAO = 0.05
COLUNAS_ANALISES = ['loja', 'vendedor', 'produto', 'cliente_genero', 'forma_pagamento']
...
colunas_filtradas = [c for c in COLUNAS_ANALISES if not c in indice_dinamico]
...
metrica_analise = st.sidebar.selectbox('Selecionar a méttrica', list(FUNCOES_AGREGACAO.keys()))
