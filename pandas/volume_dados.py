...
date_final = st.sidebar.date_input('Data Final', data_default)

df_compras_filter = df_compras[(df_compras.index.date >= data_inicio) & (df_compras.index.date < date_final + timedelta(days=1))]
